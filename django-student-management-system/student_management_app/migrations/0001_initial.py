    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('installment_option', models.CharField(default='Monthly', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('Load_Limit', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.AddField(
            ...
            name='GradeLevel_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.gradelevel'),
        ),
        migrations.CreateModel(
            name='AssignSection',
            fields=[
